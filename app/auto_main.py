...
def main():
    ...
    if args.file and args.type and args.input:
        ...
        json_data = aeaneas_json(
            input=args.input, csv=csv, gentle_file=args.file, type=args.input
        )
        # print(json_data)
        ...
        print(
            "Please input correct value for example using -i kamal and -f file_name and -t gentle or normal"
        )
