...
def adding_head_and_body(head, body_path, frame_name, rotation=0):
    ...
    new_image = adding_image(body, head, 
                            location=character_body_cordination_data[character_number][body_image_name]["head_position"], 
                            rotation=rotation, 
                            mirror=False, 
                            size_cordinates=character_body_cordination_data[character_number][body_image_name]["head_size"])
